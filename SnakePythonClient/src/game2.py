...
if __name__ == "__main__":
    ...
    while True:
        try:
            ...
            # CRITICAL FIX: Removed the 'if s_info.alive' restriction. 
            # Dead snakes are now permanently registered as lethal blocks!
            dangerous_cells = set()
            ...
            if current_length < LENGTH_THRESHOLD:
                ...
                if safe_moves and apples:
                    ...
                    if chosen_move:
                        print(f"[GREEDY] Length {current_length}/{LENGTH_THRESHOLD} -> Moving towards apple.")
            else:
                # POLICY 2: SAFE SURVIVAL MODE
                print(f"[SURVIVAL] Length {current_length} >= {LENGTH_THRESHOLD} -> Maximizing survival arena space.")
